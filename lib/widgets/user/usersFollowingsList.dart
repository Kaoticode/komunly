...
class UsersFollowingList extends StatefulWidget {
  final String userId;
  const UsersFollowingList({
    Key? key,
    required this.userId,
  }) : super(key: key);

  @override
  State<UsersFollowingList> createState() => _UsersState();
}

class _UsersState extends State<UsersFollowingList> {
  ...
  Future<void> fetchUsers() async {
    ...
    String apiUrl =
        "$API_URL/follows/following/${widget.userId}?page=$page&limit=$limit${checkSearch()}";
            ...
            children: [
              CircleAvatar(
                ...
                backgroundImage: NetworkImage(
                    "$PROFILE_IMG_URL/${userData["following"]["profilePicture"] ?? "$DEFAULT_IMAGE"}"),
              ),
                  ...
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => ProfilePage(
                        id: userData["following"]["_id"],
                        profilePicture: userData["following"]
                                ["profilePicture"] ??
                            DEFAULT_IMAGE,
                        username:
                            userData["following"]["username"] ?? "Usuario",
