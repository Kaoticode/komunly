...
class UsersList extends StatefulWidget {
  ...
  @override
  State<UsersList> createState() => _UsersState();
}
      ...
      children: [
        ...
        Expanded(
          child: ListView.builder(
            ...
            itemCount:
                usersData.isEmpty ? 1 : usersData.length + (isLoading ? 1 : 0),
                  ...
                  children: [
                    userData["premium"] == true
                        ? Row(
                            children: [
                              PremiumUser(
                                  username: userData["username"], fontSize: 14),
                  ...
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => ProfilePage(
                        id: userData["_id"],
                        profilePicture:
                            userData["profilePicture"] ?? DEFAULT_IMAGE,
